...
namespace gl
{
	...
	enum
	{
		...
		SIGNALED                         = 0x9119,
		//STACK_OVERFLOW taken from ext: 1.1
		//STACK_UNDERFLOW taken from ext: 1.1
		...
		//MAX_VERTEX_STREAMS taken from ext: 4.0
		...
		SRGB_READ                        = 0x8297,
		SRGB_WRITE                       = 0x8298,
		//STACK_OVERFLOW taken from ext: 3.2
		//STACK_UNDERFLOW taken from ext: 3.2
